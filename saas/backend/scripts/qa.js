...
const suites = [
  { id: 'unit-harness', group: 'unit', cwd: backend, run: nodeTest(['test/benchmarkStatistics.test.js', 'test/processHarness.test.js', 'test/benchmarkRunner.test.js', 'test/securityConfiguration.test.js']) },
